...
### Google Maps API (Alaín)

+ What is Google Maps API
+ How google maps api works?
+ How Clustering Models works?
+ How the recommendations looks like?
...
![Overview of the pipeline executed on Luigi\label{dagpipeline}](./images/dag_pipeline.png)
...
A template to create a Luigi pipeline using Docker is available at https://github.com/nanounanue/pipeline-template. 
